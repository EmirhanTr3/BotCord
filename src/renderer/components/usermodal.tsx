...
import { Badge, BotBadge, PFP, UserStatus, HoverText, T } from ".";
...
export default forwardRef<HTMLDivElement, {user: Member, location: {x: number, y: number}}>((props, ref) => {
    ...
    return <div ref={ref} id="usermodal" style={{top: location.y, left: location.x}}>
        ...
        {!user.bot &&
            <div id="buttons">
                <HoverText text={t("usermodal.sendmessage")}>
        ...
        <div id="info">
            ...
            <div id="content">
                {UserAboutMe &&
                    <div id="aboutme">
                        <h1 id="title"><T k="usermodal.aboutme" /></h1>
                        <p dangerouslySetInnerHTML={{ __html: parseContent(UserAboutMe) }}></p>
                    </div>
                }
                <div id="membersince">
                    <h1 id="title"><T k="usermodal.membersince" /></h1>
                    <div id="discord">
                ...
                {user.roles && user.roles.filter(r => !r.isEveryone).length > 0 &&
                    <div id="roles">
                        <h1 id="title"><T k="usermodal.roles" v={{count: user.roles.length}} /></h1>
                        <div id="list">
